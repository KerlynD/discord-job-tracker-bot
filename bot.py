...
from models import create_engine_and_session, init_database, Stage
...
async def list_applications(
    interaction: discord.Interaction,
    stage: Optional[Literal["Applied", "OA", "Phone", "On-site", "Offer", "Rejected"]] = None,
    page: int = 1
):
...
async def todo_applications(interaction: discord.Interaction):
    ...
    try:
        ...
        logger.error(f"Error getting todo list: {e}")
